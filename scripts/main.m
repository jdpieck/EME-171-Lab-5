...
initial = initialize(I_p, Q_init, C_t, C_f, d_0, d_1, d_2, g, rho);
tspan = find_time_control_parameters(C_t, I_p);

turbine_handle = @(t) turbine_profile(t, Q_init, t_ramp, t_start_shutdown);
